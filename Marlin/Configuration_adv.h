 ...
 */
//#define LIN_ADVANCE // TRONXY CHITU_V6 does not like LIN_ADVANCE
 ...
 */
   ...
   */
    ...
    #define TOOLCHANGE_FS_EXTRA_RESUME_LENGTH  -1.5  // (mm) Extra length for better restart, fine tune by LCD/Gcode)
